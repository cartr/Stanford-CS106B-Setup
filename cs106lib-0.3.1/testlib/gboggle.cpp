 ...
 * -------------------------------------------------------------------------------
 * Removed from open-source version Sept 2011 as it doesn't work and isn't needed
 * see comments for AddToScoreForPlayer()
...
static struct {
    const char *colorName; // "const" added Sept 2011 to suppress a warning from gcc
